...
### 결과 비교 (26씬 통합, best: time 799 / position 600)

| 지표 | time | position | 판정 |
|---|---|---|---|
| **frame 기준 거리 오차 (:ref csv, m)** | **0.712** | 0.723 | time 우위 (1.5%, 0.011m) |
| **횡오차 lateral (경로선 붙음, 실차 핵심, m)** | 0.075 | **0.068** | **position** (p134 시각적으로 크게 개선 0.19→**0.05**) |
