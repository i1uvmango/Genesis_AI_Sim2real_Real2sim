...
**이번 결과 / 막힌 것 / 다음**
- 결과: 개루프 재생 9.05 m 발산 → 횡오차 되먹임 도입으로 32씬 평균 CTE 13.2 → 4.7 cm (n=32, 30개 씬 개선)
- 결과: 복구 모드 목표 인덱스 전진 상한(1.0 idx/frame)으로 완주 30/31 → 31/31, 종점 고정 1448 → 7 프레임 (n=31)
- 막힌 것: switch 로직으로 인한 dual policy / 통합 단일 policy
- 다음: 장애물 회피 훈련
